 ...
 * @constructor
 */
function AuthForm({children, title, onChange, onSubmit, value, validity, errors}) {
    return (
        <div className="popup__container popup__container_type_auth">
            ...
            <form className="popup__form popup__form_type_auth"  onSubmit={onSubmit}>
                <label className="popup__form-label popup__form-label_type_auth">
                    <input className={`popup__input popup__input_type_auth ${validity.emailValidity ? null : 'popup__input_type_error'}`}
                           id="title"
                           name="email"
                           type="email"
                           placeholder="Email"
                ...
                <label className="popup__form-label popup__form-label_type_auth">
                    <input className={`popup__input popup__input_type_auth ${validity.passwordValidity ? null : 'popup__input_type_error'}`}
                           id="subtitle"
                           name="password"
                           type="password"
